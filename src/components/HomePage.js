...
class HomePage extends React.Component{
    ...
    render(){
        ...
        if (this.props.items === null) {
            ...
            <br/>
            <div className="row">
                <div className="col-6"><h2>Top Rated</h2></div>
                <div className="col-6" >
                ...
                {this.state.top.map((item)=>{
                    ...
                    return(<>
                        <div className="block" key={item.id} onClick={this.toggle}>
                            <img  src={name} onClick={this.MovieInfo.bind(this, item.id,name,item.original_title)}/>
                        </div>;
                         </>   
                    )
                })}
            ...
            <br/>
            <div className="row">
                <div className="col-6"><h2>Upcoming</h2></div>
                <div className="col-6" >
                       <NavLink className="nav-link" to="/browse">
                            <h3 style={{float:"right"}} >See all</h3>
                        </NavLink>
            ...
            <br/>
            <div className="row">
                <div className="col-6"><h2>Popular</h2></div>
                <div className="col-6" >
                       <NavLink className="nav-link" to="/browse">
                            <h3 style={{float:"right"}} >See all</h3>
                        </NavLink>
